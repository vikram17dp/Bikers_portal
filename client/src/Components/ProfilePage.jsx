          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              {isEdit ? (
                ...
                <p className="text-lg text-gray-900 bg-white p-3 rounded-lg shadow-sm">{userData.dob || 'Not Specified'}</p>
              )}
            </div>
          </div>
        </div>
      ...
      <div className="mt-12 flex justify-end">
        {isEdit ? (
          <button
            ...
            disabled={isLoading}
            className="inline-flex items-center justify-center py-2 px-4 border border-transparent shadow-sm text-lg font-medium rounded-full text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-300 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isLoading ? (
              <>
          ...
          <button
            ...
            className="inline-flex justify-center py-2 px-6 border border-transparent shadow-sm text-lg font-medium rounded-full text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-300 ease-in-out"
          >
            Edit Profile
          </button>
        )}
