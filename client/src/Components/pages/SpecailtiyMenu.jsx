...
const SpecailtiyMenu = () => {
  return (
    <div id='speciality' className='flex flex-col items-center gap-4 py-16 text-gray-800'>
        <h1 className='text-3xl font-medium'>Explore by Category
        </h1>
        <p className='sm:w-1/3 text-center text-sm'>Discover the best selection of bikes, parts, and accessories. 
